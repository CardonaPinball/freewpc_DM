...
struct adjustment_value collection_text_value = { 0, NUM_CURRENCY_TYPES-1, 1, collection_text_render };
...
struct adjustment standard_adjustments[] = {
	...
	{ "REPLAY" STR_LEVEL, &replay_score_value, REPLAY_SCORE_TYPE_DEFAULT, &system_config.replay_level[0] },
...
//	{ "ALLOW DIM ALLUM.", &yes_no_value, YES, &system_config.allow_dim_illum },
	...
	{ "COIN DOOR SAVER", &yes_no_value, YES, &system_config.coin_door_ball_save },
...
struct adjustment feature_adjustments[] = {
	...
	{ "EYE EX BALL", &integer_value, 10, &system_config.eyeball_eb },
	{ "NUM 2 EXPLODE", &integer_value, 2, &system_config.num2explode },
	{ "NUM 2 FREEZE", &integer_value, 4, &system_config.num2freeze },
	{ "JETS GOAL", &integer_value, 25, &system_config.jets_goal },
	{ "NUM 2 CHASE", &integer_value, 2, &system_config.num2chase },
	{ "COMBO 4 COMPUTER", &integer_value, 10, &system_config.num2comp_award },
	{ "COMBO 4 VIDEO", &integer_value, 10, &system_config.num2video },
	{ "NUM 2 HUXLEY", &integer_value, 2, &system_config.num2huxley },
	{ "NUM 2 DEMOTIME", &integer_value, 4, &system_config.num2demotime },
	{ "MB BALLSAVE", &integer_value, 10, &system_config.mb_ballsave },
	{ "MODE BALLSAVE", &integer_value, 10, &system_config.mode_ballsave },
	{ "VM LEVEL", &integer_value, 1, &system_config.vm_level },
	{ "EXTRA SOUNDS", &yes_no_value, NO, &system_config.extra_sounds},
	{ "SWEAR SOUNDS", &yes_no_value, NO, &system_config.swear_sounds },
	{ "DISABLE KABOOM", &yes_no_value, NO, &system_config.disable_kaboom },
	{ "DISABLE SIMON SEZ", &yes_no_value, NO, &system_config.disable_simon_says },
	{ "DISABLE SHOOTER", &yes_no_value, NO, &system_config.disable_shooter },
	{ "DISABLE CLAW", &yes_no_value, NO, &system_config.disable_claw },
	{ "DISABLE SHAKER", &yes_no_value, YES, &system_config.disable_shaker },
	{ "EXTRA SHAKER", &yes_no_value, NO, &system_config.extra_shaker },
	{ "DISABLE KNOCKER", &yes_no_value, NO, &system_config.disable_knocker },
