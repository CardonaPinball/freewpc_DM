 ...
 ****************************************************************************/
#define KABOOM_BOMB_CAUGHT					SC_500K //first round is 20

#define SHOOTING_GALLERY_OBJECT_SHOT		SC_500K //max of 25 bullets - typically make around 20

#define SHOOTER_SCORE						SC_250K //about 45 bullets and 40 targets
#define SHOOTER_ABORT_SCORE					SC_1M //about 45 bullets and 40 targets
