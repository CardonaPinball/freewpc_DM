...
void fortress_start_effect_deff(void) {
	...
	fortress_animation_display_effect (IMG_CAPSIMON_B_START, IMG_CAPSIMON_B_END);
	fortress_animation_display_effect (IMG_SIMON_A_START, IMG_SIMON_A_END);
	fortress_frame_with_words_display_steel_effect (IMG_SIMON_A_END, DMD_MIDDLE_X, DMD_BIG_CY_Bot, "MULTIBALL");
	task_sleep_sec (1);
	deff_exit ();
